...
if($payV == $this->aliAlias){
	echo '<li data-EmailKey="'.$this->aliEmailKey.'" data-TitleKey="'.$this->aliTitleKey.'" data-MoneyKey="'.$this->aliMoneyKey.'" data-payAlias="'.$this->aliAlias.'"><img src="images/'.$payV.'.png" height="45" /></li>';

}elseif($payV == $this->wxAlias){

  echo '<li data-EmailKey="'.$this->wxEmailKey.'" data-TitleKey="'.$this->wxTitleKey.'" data-MoneyKey="'.$this->wxMoneyKey.'" data-payAlias="'.$this->wxAlias.'"><img src="images/'.$payV.'.png" height="45" /></li>';
 
}elseif($payV == $this->tenAlias){

  echo '<li data-EmailKey="'.$this->tenEmailKey.'" data-TitleKey="'.$this->tenTitleKey.'" data-MoneyKey="'.$this->tenMoneyKey.'" data-payAlias="'.$this->tenAlias.'"><img src="images/'.$payV.'.png" height="45" /></li>';
}
