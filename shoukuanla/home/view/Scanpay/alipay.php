...
if($post['isWriteNote'] == '1'){
   echo '<img id="qrimage" src="'.SKL_WEBROOT_PATH.'images/aliqrcode.jpg" width="230" />
   ';	
}else{  
 	      
   echo '<img id="qrimage" src="'.SKL_WEBROOT_PATH.'images/aliqrcode/'.$post['money'].'/'.$post['fileName'].'" width="230" />
   ';	
}
?>           
