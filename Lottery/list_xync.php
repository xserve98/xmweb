...
<link rel="stylesheet" type="text/css" href="/newdsn/css/g_KLSF.css" />
...
<thead><tr class="tit">
                ...
                <th width="100">期数</th>
                <th width="102">开奖时间</th>
                <th width="368" colspan="8">开出号码</th>
                <th colspan="4">总和</th>
                <th>龙虎</th>
...
<tbody>
                ...
                if($id) {
                    ...
                    while($row = $query->fetch_array()) {
                        ...
                        <tr class="list">
                            ...
                            <td class="xync"><em class="n_<?=$row['ball_1']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_2']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_3']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_4']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_5']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_6']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_7']?>"></em></td>
                            <td class="xync"><em class="n_<?=$row['ball_8']?>"></em></td>
            ...
            ?>
            <thead><tr>
                <th colspan="15"><?php echo $pageStr; ?></th>
            </tr></thead>
     </tbody></table>
    </div>
