...
$sql = "select ball_1,ball_2,ball_3,ball_4,ball_5 from c_auto_27 where $date and ok=1 order by id asc";
...
//十期开奖结果
$sql = "select qishu,ball_1,ball_2,ball_3,ball_4,ball_5 from c_auto_27 where ok=1 order by qishu desc limit 10";
$query = $mysqli->query($sql);
$kj_list = array();
