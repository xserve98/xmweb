...
//十期开奖结果
$sql = "select qishu,ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7,ball_8,ball_9,ball_10,ball_11,ball_12,ball_13,ball_14,ball_15,ball_16,ball_17,ball_18,ball_19,ball_20 from c_auto_30 where ok=1 order by qishu desc limit 10";
$query = $mysqli->query($sql);
$kj_list = array();
