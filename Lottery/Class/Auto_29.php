...
$sql = "select ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7,ball_8,ball_9,ball_10 from c_auto_29 where $datetime and ok=1 order by id asc";
$query = $mysqli->query($sql);
$history = array();
...
//十期开奖结果
$sql = "select qishu,ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7,ball_8,ball_9,ball_10 from c_auto_29 where ok=1 order by qishu desc limit 10";
$query = $mysqli->query($sql);
$kj_list = array();
