...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">北京快乐8</span> — <span class="gameName" id="gameName"> <?=$type?></span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<?php include_once('kj.php') ?>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="/Lottery/order/order.php?type=1" method="post" target="OrderFrame">
            <?php if($type == '两面盘') { ?>
