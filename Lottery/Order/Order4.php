...
//北京赛车(PK10)
if ($_REQUEST['type'] == 4 || $_REQUEST['type'] == 8 || $_REQUEST['type'] == 24 || $_REQUEST['type'] == 29 || $_REQUEST['type'] == 17) {
	//获取彩种
    ...
    } else if($_REQUEST['type'] == 29){
        $qishu = lottery_qishu_29($_REQUEST['type']);
	} else if($_REQUEST['type'] == 24){
        $qishu = lottery_qishu_24($_REQUEST['type']);
	} else if($_REQUEST['type'] == 17){
        $qishu = lottery_qishu_17($_REQUEST['type']);
    } else {
