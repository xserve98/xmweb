...
<title>Welcome</title>
	...
	<link type="text/css" rel="stylesheet" href="/js/skin/layer.css" id="layui_layer_skinlayercss">
...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">极速赛车(PK10)</span> — <span class="gameName" id="gameName"> <?=$type?></span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<?php include_once('kj.php') ?>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="/Lottery/order/order4.php?type=24" method="post" target="OrderFrame">
            <?php if($type == '两面盘') { ?>
			<table cellspacing="1" cellpadding="0" border="0" class="tab1">
				...
				<table class="tab1 b_num" border="0" cellpadding="0" cellspacing="1">
                            <tr class="tr_tit">
                                <td class="tit" colspan="3">冠军龙虎 1V10</td>
                                <td class="tit" colspan="3">亚军龙虎 2V9</td>
                                <td class="tit" colspan="3">季军龙虎 3V8</td>
                                <td class="tit" colspan="3">第四龙虎 4V7</td>
                                <td class="tit" colspan="3">第五龙虎 5V6</td>
                            </tr>
                            <tr class="tr_txt">
            ...
            <?php } elseif($type == '冠亚军和') { ?>
				...
				<?php } elseif($type == '冠亚季军和') { ?>
				<table class="bian" border="0" cellpadding="0" cellspacing="1">
                            <tr class="tr_tit">
                                <td  colspan="12" class="tit">冠亚季军和（冠军车号+亚军车号+季军车号=总和）</td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>6</td>
                                <td class="bian_td_odds" id="ball_17_h1"></td>
                                <td class="bian_td_inp" id="ball_17_t1"></td>
                                <td class="bian_td_qiu"><b>7</td>
                                <td class="bian_td_odds" id="ball_17_h2"></td>
                                <td class="bian_td_inp" id="ball_17_t2"></td>
                                <td class="bian_td_qiu"><b>8</td>
                                <td class="bian_td_odds" id="ball_17_h3"></td>
                                <td class="bian_td_inp" id="ball_17_t3"></td>
                                <td class="bian_td_qiu"><b>9</td>
                                <td class="bian_td_odds" id="ball_17_h4"></td>
                                <td class="bian_td_inp" id="ball_17_t4"></td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>10</td>
                                <td class="bian_td_odds" id="ball_17_h5"></td>
                                <td class="bian_td_inp" id="ball_17_t5"></td>
                                <td class="bian_td_qiu"><b>11</td>
                                <td class="bian_td_odds" id="ball_17_h6"></td>
                                <td class="bian_td_inp" id="ball_17_t6"></td>
                                <td class="bian_td_qiu"><b>12</td>
                                <td class="bian_td_odds" id="ball_17_h7"></td>
                                <td class="bian_td_inp" id="ball_17_t7"></td>
                                <td class="bian_td_qiu"><b>13</td>
                                <td class="bian_td_odds" id="ball_17_h8"></td>
                                <td class="bian_td_inp" id="ball_17_t8"></td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>14</td>
                                <td class="bian_td_odds" id="ball_17_h9"></td>
                                <td class="bian_td_inp" id="ball_17_t9"></td>
                                <td class="bian_td_qiu"><b>15</td>
                                <td class="bian_td_odds" id="ball_17_h10"></td>
                                <td class="bian_td_inp" id="ball_17_t10"></td>
                                <td class="bian_td_qiu"><b>16</td>
                                <td class="bian_td_odds" id="ball_17_h11"></td>
                                <td class="bian_td_inp" id="ball_17_t11"></td>
                                <td class="bian_td_qiu"><b>17</td>
                                <td class="bian_td_odds" id="ball_17_h12"></td>
                                <td class="bian_td_inp" id="ball_17_t12"></td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>18</td>
                                <td class="bian_td_odds" id="ball_17_h13"></td>
                                <td class="bian_td_inp" id="ball_17_t13"></td>
                                <td class="bian_td_qiu"><b>19</td>
                                <td class="bian_td_odds" id="ball_17_h14"></td>
                                <td class="bian_td_inp" id="ball_17_t14"></td>
                                <td class="bian_td_qiu"><b>20</td>
                                <td class="bian_td_odds" id="ball_17_h15"></td>
                                <td class="bian_td_inp" id="ball_17_t15"></td>
                                <td class="bian_td_qiu"><b>21</td>
                                <td class="bian_td_odds" id="ball_17_h16"></td>
                                <td class="bian_td_inp" id="ball_17_t16"></td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>22</td>
                                <td class="bian_td_odds" id="ball_17_h17"></td>
                                <td class="bian_td_inp" id="ball_17_t17"></td>
                                <td class="bian_td_qiu"><b>23</td>
                                <td class="bian_td_odds" id="ball_17_h18"></td>
                                <td class="bian_td_inp" id="ball_17_t18"></td>
                                <td class="bian_td_qiu"><b>24</td>
                                <td class="bian_td_odds" id="ball_17_h19"></td>
                                <td class="bian_td_inp" id="ball_17_t19"></td>
                                <td class="bian_td_qiu"><b>25</td>
                                <td class="bian_td_odds" id="ball_17_h20"></td>
                                <td class="bian_td_inp" id="ball_17_t20"></td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>26</td>
                                <td class="bian_td_odds" id="ball_17_h21"></td>
                                <td class="bian_td_inp" id="ball_17_t21"></td>
                                <td class="bian_td_qiu"><b>27</td>
                                <td class="bian_td_odds" id="ball_17_h22"></td>
                                <td class="bian_td_inp" id="ball_17_t22"></td>
                                <td colspan="6"></td>
                            </tr>
                            <tr class="tr_txt">
                                <td class="bian_td_qiu"><b>冠亚季大</td>
                                <td class="bian_td_odds" id="ball_17_h23"></td>
                                <td class="bian_td_inp" id="ball_17_t23"></td>
                                <td class="bian_td_qiu"><b>冠亚季小</td>
                                <td class="bian_td_odds" id="ball_17_h24"></td>
                                <td class="bian_td_inp" id="ball_17_t24"></td>
                                <td class="bian_td_qiu"><b>冠亚季单</td>
                                <td class="bian_td_odds" id="ball_17_h25"></td>
                                <td class="bian_td_inp" id="ball_17_t25"></td>
                                <td class="bian_td_qiu"><b>冠亚季双</td>
                                <td class="bian_td_odds" id="ball_17_h26"></td>
                                <td class="bian_td_inp" id="ball_17_t26"></td>
                            </tr>
                        </table>
...
<input type="button" class="button" id="xiazhu" value="下注"  onclick="order();"><input type="button" class="button" value="重置" onclick="formReset();">
	...
	<DIV style="POSITION: absolute; DISPLAY: block; TOP: 10px; LEFT: 810px" id="changlong"></DIV>
