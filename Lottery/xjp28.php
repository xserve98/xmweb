...
<head>
    ...
    <script type="text/javascript" src="Js/xjp28.js"></script>
...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">新加坡28</span> — <span class="gameName" id="gameName"> <?=$type?></span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<?php include_once('kj.php') ?>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="/Lottery/Order/Order5.php?type=23" method="post" target="OrderFrame">
