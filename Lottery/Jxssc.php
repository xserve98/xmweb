...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">天津时时彩</span> — <span class="gameName" id="gameName"> <?=$type?></span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<?php include_once('kj.php') ?>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="/Lottery/order/order.php?type=7" method="post" target="OrderFrame">
            <?php if($type == '两面盘') { ?>
                <div class="t_box">
