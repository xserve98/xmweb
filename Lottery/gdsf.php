...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">广东快乐十分</span> — <span class="gameName" id="gameName"> <?=$type?></span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
