...
<div class="wraper">
<div class="tit">
	<a href="javascript:history.go(-1)" class="return" data-ajax="false"></a>微信扫码
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr>
			<td colspan="2" class="pay_ma">
				<span>　　　　 <img src="/member/images/wx.jpg" width="200" /></span>
			</td>
		</tr>
		<form id="form1" method="post" action="hk_money.php?into=true" name="form1">
			...
			<tr>
				...
				<td>
					<input type="hidden" name="IntoBank" value="微信扫码" />
					<input type="hidden" name="InType" value="微信扫码" />
