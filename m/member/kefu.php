...
<body mode="gm">
    <div class="container-fluid gm_main">
	 ...
	 <iframe src="http://api.pop800.com/chat/283891" id="iframepage" style="padding-bottom: 46px;"  name="iframepage" frameBorder=0 scrolling=no width="100%"  height=100%></iframe>  
