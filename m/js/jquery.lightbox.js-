	...
	$.fn.lightbox = function(options) {
		...
		*/
		...
		$.fn.lightbox.defaults = {
		  triggerEvent: "click",
			allSet: false,
			fileLoadingImage: '../images/all/lightbox/loading.gif'/*tpa=http://juyou1989.com/cscpLoginWeb/images/all/lightbox/loading.gif*/,
			fileBottomNavCloseImage: '../images/all/lightbox/closelabel.gif'/*tpa=http://juyou1989.com/cscpLoginWeb/images/all/lightbox/closelabel.gif*/,
			overlayOpacity: 0.6,
			borderSize: 10,
