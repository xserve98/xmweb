...
<head>
    ...
    <script type="text/javascript" src="Js/azxy8.js"></script>
...
<body>
	...
	<div class="container-fluid gm_main">
		...
		<div class="tit">
			...
			<a href="#u_nav" class="dh" data-ajax="false"></a>澳洲幸运8
            ...
            <ul class="g_type">
                <li>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered">
                        ...
                        <tr><td><a href="azxy8.php?t=两面盘">两面盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第一球">第一球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第二球">第二球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第三球">第三球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第四球">第四球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第五球">第五球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第六球">第六球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第七球">第七球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy8.php?t=第八球">第八球</a> <i class="icon-angle-right"></i></td></tr>
                    </table>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order3.php?type=28" method="post" target="OrderFrame">
                    <?php if($type == '两面盘') { ?>
                        <div class="tz_box">
                            <div class="info_con ico2">总和、龙虎</div>
                            <ul>
                                <li>
                                    <div class="wf_box">
                                        <div class="wf_info">
