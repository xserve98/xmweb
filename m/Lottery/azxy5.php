...
<head>
    ...
    <script type="text/javascript" src="Js/azxy5.js"></script>
...
<body>
	...
	<div class="container-fluid gm_main">
		...
		<div class="tit">
			...
			<a href="#u_nav" class="dh" data-ajax="false"></a>澳洲幸运5
            ...
            <ul class="g_type">
                <li>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered">
                        ...
                        <tr><td><a href="azxy5.php?t=两面盘">两面盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy5.php?t=数字盘">数字盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy5.php?t=第一球">第一球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy5.php?t=第二球">第二球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy5.php?t=第三球">第三球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy5.php?t=第四球">第四球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy5.php?t=第五球">第五球</a> <i class="icon-angle-right"></i></td></tr>
                    </table>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=27" method="post" target="OrderFrame">
                    <?php if($type == '两面盘') { ?>
                        <?php for($s = 1; $s <= 5; $s++) { ?>
                            <div class="tz_box">
