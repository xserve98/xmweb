...
<head>
    ...
    <script type="text/javascript" src="Js/azxy10.js"></script>
...
<body>
	...
	<div class="container-fluid gm_main">
		...
		<div class="tit">
			...
			<a href="#u_nav" class="dh" data-ajax="false"></a>澳洲幸运10
            ...
            <ul class="g_type">
                <li>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered">
                        ...
                        <tr><td><a href="azxy10.php?t=两面盘">两面盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy10.php?t=冠亚和">冠亚和</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy10.php?t=1~10名">1~10名</a> <i class="icon-angle-right"></i></td></tr>
                    </table>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order4.php?type=29" method="post" target="OrderFrame">
                    <?php if($type == '两面盘') { ?>
                        <div class="tz_box">
                            <div class="info_con ico2">冠，亚军和</span></div>
                            <ul>
                                <li>
                                    <div class="wf_box">
                                        <div class="wf_info">
