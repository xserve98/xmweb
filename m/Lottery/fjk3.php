...
<head>
    ...
    <script type="text/javascript" src="js/fjk3.js"></script>
...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">福建快三</span> — <span class="gameName" 
...
<?php include_once('kj.php') ?>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="/Lottery/order/order.php?type=31" method="post" target="OrderFrame">
            <?php if($type == '两面盘') { ?>
                <div class="t_box">
