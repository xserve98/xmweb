...
//开始读取赔率
$sql		= "select * from c_odds_34 order by id asc";
...
$curl->set_referrer("http://old.1680210.com/lottery/10082.html");
...
$html_data = $curl->fetch_url("http://kj.1680api.com/Open/CurrentOpenOne?code=10082");
