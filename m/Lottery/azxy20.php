...
<head>
    ...
    <script type="text/javascript" src="Js/azxy20.js"></script>
...
<body>
	...
	<div class="container-fluid gm_main">
		...
		<div class="tit">
			...
			<a href="#u_nav" class="dh" data-ajax="false"></a>澳洲幸运20
            ...
            <ul class="g_type">
                <li>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered">
                        ...
                        <tr><td><a href="azxy20.php?t=两面盘">两面盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy20.php?t=选一">选一</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy20.php?t=选二">选二</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy20.php?t=选三">选三</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy20.php?t=选四">选四</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="azxy20.php?t=选五">选五</a> <i class="icon-angle-right"></i></td></tr>
                    </table>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=30" method="post" target="OrderFrame">
                    <?php if($type == '两面盘') { ?>
                        <div class="tz_box">
