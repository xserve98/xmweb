...
<head>
    ...
    <script type="text/javascript" src="Js/shssl.js"></script>
...
<body>
	...
	<div class="container-fluid gm_main">
		...
		<div class="tit">
			...
			<a href="#u_nav" class="dh" data-ajax="false"></a>上海时时乐
            ...
            <ul class="g_type">
                <li>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered">
                        ...
                        <tr><td><a href="shssl.php?t=两面盘">两面盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="shssl.php?t=数字盘">数字盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="shssl.php?t=第一球">第一球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="shssl.php?t=第二球">第二球</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="shssl.php?t=第三球">第三球</a> <i class="icon-angle-right"></i></td></tr>
                    </table>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=5" method="post" target="OrderFrame">
                    <?php if($type == '两面盘') { ?>
                        <?php for($s = 1; $s <= 3; $s++) { ?>
                            <div class="tz_box">
                    ...
                    <?php } elseif($type == '数字盘') { ?>
                        ...
                        <?php } ?>
                        <div class="tz_box ssc">
                            <div class="info_con ico2">独胆</div>
                            <?php
                            for($s = 1; $s <= 10; $s++) {
                                if($s % 2 == 1) {
                                    echo '<ul>';
                        ...
                        <div class="tz_box ssc">
                            <div class="info_con ico2">跨度</div>
                            <?php
                            for($s = 1; $s <= 10; $s++) {
                                if($s % 2 == 1) {
                                    echo '<ul>';
