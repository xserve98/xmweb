...
<body>
	...
	<div class="container-fluid gm_main">
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="/cqsix/order/order.php?type=22&class=11" method="post" target="OrderFrame">
                    <div class="tz_box">
                    ...
                    <div class="tz_box cqsix" id="ball_1" style="display: none">
                        <div class="info_con ico2">连码</div>
                        <?php
                        for($s = 1; $s <= 49; $s++) {
                            if($s % 2 == 1) {
                                echo '<ul>';
                    ...
                    <div class="tz_box" id="ball_2" style="display: none">
                        <div class="info_con ico2">生肖</div>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                    ...
                    <div class="tz_box" id="ball_3" style="display: none">
                        <div class="info_con ico2">尾数</div>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                    ...
                    <div class="tz_box" id="ball_4" style="display: none">
                        <div class="info_con ico2">主肖</div>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                        ...
                        <div class="info_con ico2">拖尾数</div>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                    ...
                    <div class="tz_box cqsix" id="ball_5" style="display: none">
                        <?php
                        for($s = 1; $s <= 2; $s++) {
                            if($s == 1) {
                                echo '<div class="info_con ico2">胆码</div>';
                            } else {
                                echo '<div class="info_con ico2">拖码</div>';
                            }
                            for($i = 1; $i <= 49; $i++) {
                                if($i % 2 == 1) {
                                    echo '<ul>';
