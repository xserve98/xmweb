...
if($_GET["into"]=="true"){
	...
	if($manner == "支付宝转帐") {
	   $manner .= "支付宝昵称：".htmlEncode($_POST["v_Name"]);
	} elseif($manner == "0"){
...
<body>
	<div class="popup">
		<div class="popupinternal order-submit2">
			<div class="col-left">
				<p>请用支付宝扫描下面的二维码</p>
				<form id="form1" method="post" action="zfb_money.php?into=true" name="form1">
				<div class="bank-info1">
					<div id="showqrcode" style="margin-top:10px;margin-left:42px;"><img src="/xmindex/img/zfb.jpg" height="200" width="200"></div>
				</div>
				<br/>
				<div class="three-second">
					<h4>转账信息</h4>
					<p>昵称：<input name="v_Name" type="text" class="input_150" id="v_Name" onkeyup="clearNoNum(this);" maxlength="8" placeholder="填写支付宝昵称"/></input></p>
			...
			<div class="col-right">
				<div class="jc-info" style="position:relative;top:-28px;">
					<h4>如何充值：</h4>
					<p>请用支付宝扫描左侧二维码，转账给<br>财务号，并且在留言附上您的会员账号<br>例：会员账号：AAA123，充值金额为500元；请转账500元给财务号，并且请<br>留言AAA123，即可帮您充值500元。</p>
				</div><br>
				<img style="position:relative;top:-25px;margin:2 0 0 0;padding:2 0 0 0;height:188px;width:245px" src="/newdsn/images/zfbtips.png">
			</div>
