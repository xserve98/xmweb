...
class bankpay{
	...
	* 993  财付通网银支付接口URL
	*/
	const mnouvw_bank_url	= 'http://api.mnouvw.com/Bank/';
	...
	*/
	public function send(){
		...
		$url .= "&attact=" . $this->attact;
		//最终url
		$url	= bankpay::mnouvw_bank_url . "?" . $url . "&sign=" .$sign. "&hrefbackurl=". $this->hrefbackurl;				
		echo $url;
		exit();
		//页面跳转
		header("location:" .$url);
