...
$hmss = array();
if(strlen($qishu)>0){
	$sql="select id from c_auto_13 where qishu='".$qishu."'";
	...
	if($tcou==0){
		$sql = "insert into c_auto_13(qishu,datetime,ok,ball_1,ball_2,ball_3,ball_4) values('".$qishu."','".$time."','0','".$d1."','".$d2."','".$d3."','".$sum."')";
...
<table width="100%"border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
      ...
      加拿大28<br>(<?=$qishu?>期:<?=$d1.'+'.$d2.'+'.$d3 .'='.$sum?>)<br>
