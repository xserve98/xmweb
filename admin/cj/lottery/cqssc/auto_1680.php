...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
      ...
      重庆时时彩<br>(<?=$qishu?>期<?=$hms[0].','.$hms[1].','.$hms[2].','.$hms[3].','.$hms[4]?>):
      <span id="timeinfo"></span>
      </td>
  </tr>
</table>
<iframe  src="./js_2.php?qi=<?=$qishu?>" width="0" height="0" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
</body>
</html>