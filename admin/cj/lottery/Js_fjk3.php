...
if($_REQUEST['ac']=='re'){
	...
	$sql		= "select * from c_auto_31 where qishu=".$qi." order by id desc limit 1";
}else{
	$sql		= "select * from c_auto_31 where ok=0";
}
...
$hm[]		= $rs['ball_3'];
//根据期数读取未结算的注单
$sql1		= "select * from c_bet where type='福建快三' and js=0 and qishu=".$qi." order by addtime asc";
...
$msql="update c_auto_31 set ok=1 where qishu=".$qi."";
