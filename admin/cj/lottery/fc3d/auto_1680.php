...
if(strlen($qishu)>0){
	...
	$hms=explode(',',$hm);
	if($tcou==0){
		$sql = "insert into c_auto_9(qishu,datetime,ok,ball_1,ball_2,ball_3) values('".$qishu."','".$time."','0','".$hms[0]."','".$hms[1]."','".$hms[2]."')";
		$mysqli->query($sql);
	}
}
?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
      ...
      福彩3D<br>(<?=$qishu?>期<?="$hms[0],$hms[1],$hms[2]"?>):
