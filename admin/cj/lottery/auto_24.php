...
if($qs){
	...
	if($qs){
		...
		$sql2="select * from c_auto_24 where qishu='".$qishu."' ";
		...
		if($tcou==0){
			...
			$tcou	= $mysqli->affected_rows;
			if($tcou==0){
				$sql3 	= "insert into c_auto_24(qishu,datetime,ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7,ball_8,ball_9,ball_10) values ('$qishu','$time','$num1','$num2','$num3','$num4','$num5','$num6','$num7','$num8','$num9','$num10')";
			}
...
<iframe src="./js_24.php?qi=<?=$qishu?>" frameborder="0" scrolling="no" height="0" width="0"></iframe>
</body>
</html>