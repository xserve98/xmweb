...
$sql			=	$sql."ask='$ask',answer='$answer',mobile='$mobile',qq='$qq',fandian='$fandian',pankou='$pankou',email='$email',pay_name='$pay_name',pay_card='$pay_card',pay_address='$pay_address',pay_num='$pay_num',gid='$gid',why='$why'";
