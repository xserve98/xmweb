...
$sql	=	"select distinct u.uid,ul.is_login as ul_type from k_user u left join k_group g on u.gid=g.id left join k_user_login ul on u.uid=ul.uid where u.is_delete=0  and is_daili=0 and guest=0";
...
<table width="100%">
      <tr>
       ...
       <td width="104" align="center"><a href="?top_uid=0">直属会员</a></td>
...
<table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color: #225d9c;" id=editProduct   idth="100%" >       <tr style="background-color: #EFE" class="t-title"  align="center">
        ...
        <td width="13%" ><strong>手机号码/微信</strong></td>
