...
//所有该会员的存款取款记录以及加减款
$sql		=	"SELECT  m_id,uid,parents, fxdltype FROM  `k_money2` WHERE  `m_make_time`>='$q_btime' and `m_make_time`<='$q_etime' ".$sqlwhere." and guest=0  order by m_id desc limit 1000";
...
//所有该会员的存款取款记录以及加减款
$sql		=	"SELECT * FROM  `k_money2` WHERE  `m_make_time`>='$q_btime' and `m_make_time`<='$q_etime' ".$sqlwhere." and guest=0 order by m_id desc limit 1000";
