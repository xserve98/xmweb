...
$sql_bak="select * from c_bet_bak order by dotime desc limit 100";
...
<table width="100%" height="99.3%" border="0" cellspacing="0" class="a">
  <tr>
    ...
    <td class="c"><table width="100%" border="0" cellspacing="0" class="main">
        <tr>
          <td width="12"><img src="../images/tab_03.gif" alt="" /></td>
          <td background="../images/tab_05.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="17"><img src="../images/tb.gif" width="16" height="16" /></td>
                <td><font style="font-weight:bold" color="#344B50">&nbsp;注單校驗</font></td>
                
              </tr>
            </table></td>
          <td width="16"><img src="../images/tab_07.gif" alt="" /></td>
        </tr>
        <tr>
          <td class="t"></td>
          <td class="c"><!-- strat -->
