...
if($save=='ok'){
	if($type<4){
		...
		$mysqli->query($sql);
		$sql	=	"update c_odds_9_c set h1=".$_REQUEST['CNum_1'].",h2=".$_REQUEST['CNum_2'].",h3=".$_REQUEST['CNum_3'].",h4=".$_REQUEST['CNum_4'].",h5=".$_REQUEST['CNum_5'].",h6=".$_REQUEST['CNum_6'].",h7=".$_REQUEST['CNum_7'].",h8=".$_REQUEST['CNum_8'].",h9=".$_REQUEST['CNum_9'].",h10=".$_REQUEST['CNum_10'].",h11=".$_REQUEST['CNum_11'].",h12=".$_REQUEST['CNum_12'].",h13=".$_REQUEST['CNum_13'].",h14=".$_REQUEST['CNum_14']." where type='ball_".$type."'";
		$mysqli->query($sql);
			$sql	=	"update c_odds_9_b set h1=".$_REQUEST['BNum_1'].",h2=".$_REQUEST['BNum_2'].",h3=".$_REQUEST['BNum_3'].",h4=".$_REQUEST['BNum_4'].",h5=".$_REQUEST['BNum_5'].",h6=".$_REQUEST['BNum_6'].",h7=".$_REQUEST['BNum_7'].",h8=".$_REQUEST['BNum_8'].",h9=".$_REQUEST['BNum_9'].",h10=".$_REQUEST['BNum_10'].",h11=".$_REQUEST['BNum_11'].",h12=".$_REQUEST['BNum_12'].",h13=".$_REQUEST['BNum_13'].",h14=".$_REQUEST['BNum_14']." where type='ball_".$type."'";
		$mysqli->query($sql);
	...
	if($type==4){
		...
		$mysqli->query($sql);
			$sql	=	"update c_odds_9_c set h1=".$_REQUEST['CNum_1'].",h2=".$_REQUEST['CNum_2'].",h3=".$_REQUEST['CNum_3'].",h4=".$_REQUEST['CNum_4'].",h5=".$_REQUEST['CNum_5'].",h6=".$_REQUEST['CNum_6'].",h7=".$_REQUEST['CNum_7']." where type='ball_".$type."'";
		$mysqli->query($sql);
			$sql	=	"update c_odds_9_b set h1=".$_REQUEST['BNum_1'].",h2=".$_REQUEST['BNum_2'].",h3=".$_REQUEST['BNum_3'].",h4=".$_REQUEST['BNum_4'].",h5=".$_REQUEST['BNum_5'].",h6=".$_REQUEST['BNum_6'].",h7=".$_REQUEST['BNum_7']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds9.php?type=".$type."");
		exit;
	}
	if($type==5){
		...
		$mysqli->query($sql);
			$sql	=	"update c_odds_9_c set h1=".$_REQUEST['CNum_1'].",h2=".$_REQUEST['CNum_2'].",h3=".$_REQUEST['CNum_3'].",h4=".$_REQUEST['CNum_4'].",h5=".$_REQUEST['CNum_5']." where type='ball_".$type."'";
		$mysqli->query($sql);
		$sql	=	"update c_odds_9_b set h1=".$_REQUEST['BNum_1'].",h2=".$_REQUEST['BNum_2'].",h3=".$_REQUEST['BNum_3'].",h4=".$_REQUEST['BNum_4'].",h5=".$_REQUEST['BNum_5']." where type='ball_".$type."'";
		$mysqli->query($sql);
	...
	if($type>5){
		...
		$mysqli->query($sql);
			$sql	=	"update c_odds_9_c set h1=".$_REQUEST['CNum_1'].",h2=".$_REQUEST['CNum_2'].",h3=".$_REQUEST['CNum_3'].",h4=".$_REQUEST['CNum_4'].",h5=".$_REQUEST['CNum_5'].",h6=".$_REQUEST['CNum_6'].",h7=".$_REQUEST['CNum_7'].",h8=".$_REQUEST['CNum_8'].",h9=".$_REQUEST['CNum_9'].",h10=".$_REQUEST['CNum_10']." where type='ball_".$type."'";
		$mysqli->query($sql);
		$sql	=	"update c_odds_9_b set h1=".$_REQUEST['BNum_1'].",h2=".$_REQUEST['BNum_2'].",h3=".$_REQUEST['BNum_3'].",h4=".$_REQUEST['BNum_4'].",h5=".$_REQUEST['BNum_5'].",h6=".$_REQUEST['BNum_6'].",h7=".$_REQUEST['BNum_7'].",h8=".$_REQUEST['BNum_8'].",h9=".$_REQUEST['BNum_9'].",h10=".$_REQUEST['BNum_10']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds9.php?type=".$type."");
		exit;
	}
