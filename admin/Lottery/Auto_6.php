...
?>
  ...
  <tr>
    ...
    <td  align="left" bgcolor="#FFFFFF">江苏快三【<a href="Uptime_6.php" style="color:#ff0000;">点击进入盘口管理</a>】</td>
  </tr>
  <tr>
...
if($id){
	...
	while($rows = $query->fetch_array()){
		...
		if($rows['ok']==1){
			...
			$ok = '<a href="../cj/lottery/js_6.php?qi='.$rows['qishu'].'&t=1"  onclick="return js();" ><font color="#0000FF">未结算</font></a>';
		}
?>
      <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
        <td height="25" align="center" valign="middle">江苏快三</td>
