...
if($_GET["dlusername"]) {
 ...
 $sql_user	 =	"select * from k_user where username='$name' limit 1"; //取汇款前会员余
     ...
     <form name="form1" method="get" action="allorder.php" onSubmit="return check();">
      <tr>
        <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;
            ...
            <option value="幸运2分彩" <?=$_GET['caizhong']=='幸运2分彩' ? 'selected' : ''?>>幸运2分彩</option>
            <option value="极速分分彩" <?=$_GET['caizhong']=='极速分分彩' ? 'selected' : ''?>>极速分分彩</option>
			<option value="香港六合彩" <?=$_GET['caizhong']=='香港六合彩' ? 'selected' : ''?>>香港六合彩</option>
			<option value="极速六合彩" <?=$_GET['caizhong']=='极速六合彩' ? 'selected' : ''?>>极速六合彩</option>
