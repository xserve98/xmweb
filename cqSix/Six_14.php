...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">极速六合彩</span> — <span class="gameName" id="gameName">尾数连</span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<div class="clearfloat"></div>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="/cqSix/order/order.php?type=22&class=14" method="post" target="OrderFrame" onkeydown="if(event.keyCode==13)return false;">
