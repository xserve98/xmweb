...
function cardname($card){
       if($card=="ICBC")$name="工商银行";
       if( $card=="CCB")$name="建设银行";
        if($card=="ABC")$name="农业银行";
       if( $card=="BOCO")$name="交通银行";
       if($card=="CEBB")$name="光大银行";
      if($card=="CMBC")$name="民生银行";
     if($card=="POST")$name="邮政银行";
    if($card=="CMB")$name="招商银行";
      if($card=="CIB")$name="兴业银行";
        if($card=="CCCB")$name="中信银行";
       if($card=="GDB")$name="广发银行";
         if($card=="SPDB")$name="浦发银行";
        if($card=="HXB")$name="华夏银行";
        if($card=="PAB")$name="平安银行";
         if($card=="SHB")$name="上海银行";
          if($card=="BJB")$name="北京银行";
        if($card=="ZZB")$name="郑州银行";
