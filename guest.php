...
<body>
<form id="form1" action="/guestreg.php" method="post" name="form1" >
...
<input id="paypasswd" name="paypasswd" type="hidden" value='123456' class="textbox1" maxlength="6" size="40"><br>
</form>
</body>
</html>