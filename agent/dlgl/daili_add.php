  ...
  <tr>
   ...
   <tr>
    <td bgcolor="#F0FFFF">占成</td>
	   <td><input name="zhancheng" type="text" id="zhancheng" value="0"  maxlength="20" style="width:150px;"><span style="color: red">您的占成：<?=$rstop['zhancheng']?>%</span></td>
  </tr> 
  <tr>
