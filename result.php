...
<link type="text/css" rel="stylesheet" href="/newindex/zb1.css" />
<link rel="stylesheet" type="text/css" href="/newdsn/css/main1.css" />
...
noticePopupWithMore(3,1,msgarr[0],timearr[0]);
noticePopupWithMore(3,2,msgarr[1],timearr[1]);
noticePopupWithMore(3,3,msgarr[2],timearr[2]);
</script>
<style type="text/css">
body {background-color:#e4edf9;}
</style> 
</head>
<body>
...
<embed src="/newdsn/images/small_logo.jpg" wmode="transparent" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="210" height="65"></object></div>
<div class="top">
<div class="menu">
  <div class="menu1"> 
  ...
  <div class="menu2">
    ...
    <span><a href="/Lottery/ssc_list.php" id='kjjg' target="frame">开奖结果</a></span><br/>
  ...
  <div class="menu4"><a target="_blank" href="https://gzzaxc826.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=737177&configID=40879&jid=1682755682&s=1" class="support"></a></div>
  <div class="menu3">
...
<div class="menucontainer">
  <div class="spritearrow arrowup"></div>
    <div id="lotterys" style="display: none">
	  ...
	  <?php } else { ?>
	  <a href="javascript:void(0)" id="l_JSSC"      lang="JSSC_2"  rel="1" ><span>极速赛车(PK10)</span></a>
	  <?php } ?>
	  <?php if (intval($web_site['pk10']) == 1) { ?>
	  <?php } else { ?>
      <a href="javascript:void(0)" id="l_BJPK10"    lang="PK10_0"  rel="0" ><span>北京赛车(PK10)</span></a>
	  <?php } ?>
	  ...
	  <?php } else { ?>  
      <a href="javascript:void(0)" id="l_XMFFC"     lang="SSC_0"   rel="3" ><span>极速分分彩</span></a>
	  <?php } ?>
	  ...
	  <?php } else { ?>  
	  <a href="javascript:void(0)" id="l_XMWFC"     lang="SSC_0"   rel="3" ><span>澳洲五分彩</span></a>
	  <?php } ?>
	  ...
	  <?php } else { ?>  
	  <a href="javascript:void(0)" id="l_BRNN"      lang="BRNN_1"  rel="8" ><span>澳洲百人牛牛</span></a>
	  <?php } ?>
	  <?php if (intval($web_site['xyft']) == 1) { ?>
	  <?php } else { ?>  
      <a href="javascript:void(0)" id="l_XYFT"      lang="PK10_0"  rel="9" ><span>幸运飞艇</span></a>
	  <?php } ?>
...
<a href="/Lottery/pl3.php?t=第三球">第三球</a>|</div>
	...
	<div id='left' class="gm_left" >
    <div id="info">
        <table id="kj_info" cellspacing="0" cellpadding="0" border="0">
            <thead style="width: 273px;">
                <tr>
                    <th>
                     <font color="#2061b3" style="font-size:25px"><span id="hk_mp3"></span>
                    <span id="gm_name"></span></font> </th>
                </tr>
            </thead>
        </table><br>
        <table id="kj_list" cellspacing="0" cellpadding="0" style="width: 473px;" border="0"></table>
    </div>
    <div id="user_order"></div>
</div>
<div class="frame" style="width: 0px; height: 0px">
<iframe id="frame"  name="frame" scrolling="no"  frameborder="0"  style="display: none;"></iframe></div>
</div>
</div>
...
<div id="resultList" class="result_list"  style="display: none;">
