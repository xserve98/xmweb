...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">香港六合彩</span> — <span class="gameName" id="gameName">过关</span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<div class="clearfloat"></div>
       ...
       <div class="touzhu">
        <form name="orders" id="orders" action="/Six/order/order.php?type=0&class=8" method="post" target="OrderFrame" onkeydown="if(event.keyCode==13)return false;">
