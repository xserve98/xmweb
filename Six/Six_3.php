...
<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">香港六合彩</span> — <span class="gameName" id="gameName"> 正码3</span><span class="result">&nbsp;今日输赢：<span id="user_sy" class="sy_n">0</span></span>
...
<div class="subbutton mt10">
    ...
    <a href="/Six/Six_3.php" class="on" >正码3</a>
